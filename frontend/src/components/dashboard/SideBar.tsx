...
const mockdata = [
  { label: '01-01-2024', icon: FaUtensils },
  {
    ...
    icon: FaUtensils,
    links: [
      { label: 'Banana: 105 cal', link: '/dashboard/table' },
      { label: 'Greek Yogurt: 100 cal', link: '/dashboard/table' },
      { label: 'Oatmeal: 150 cal', link: '/dashboard/table' },
      { label: 'Almonds: 164 cal', link: '/dashboard/table' },
    ],
  },
  {
    label: '01-03-2024',
